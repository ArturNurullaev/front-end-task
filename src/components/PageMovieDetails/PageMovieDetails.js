...
<img src={`https://image.tmdb.org/t/p/w500/${poster_path}`} className="movieDetails-image" alt="Movie details backdrop"/>
		<div>

		<p className="movieDetails-title">{original_title.toUpperCase()}</p>
		<p className="movieDetails-description"><b></b> {overview}</p>
		<p className="movieDetails-description"><b>Release date:</b> {release_date}</p>
		<p className="movieDetails-description"><b>Budget:</b> {budget}</p>
		<p className="movieDetails-description"><b>Revenue:</b> {revenue}</p>
		<p className="movieDetails-description"><b>Popularity:</b> {popularity}</p>
